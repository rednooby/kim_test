...
class _Machine:
    ...
    def fileBinary_Extraction(self, target):  # 1
        print "step [1]: fileBinary_Extraction"
        try:
    ...
    def PE_Structure_elfanewString(self):  # 2
        print "step [2] : PE_Structure_elfanewString"
        try:
            s = ""  # string
            num = 0
            ...
            print "[1] self.e_lfanew_string => {}".format(self.e_lfanew_string)
            return 1
            # end of PE_Structure_elfanewString
        except:
            print "error [PE_Structure_elfanewString]"
            return 0

    def PE_Structure_elfanewInt(self):  # 3
        print "step [3] : PE_Structure_elfanewInt"
        # NT _header first
        z = 3
    ...
    def PE_Structure_sectionText_start_size(self, s):  # 4
        print "step [4] : PE_Structure_sectionText_start_size"
        test = s
        try:
            pe = pefile.PE(test)
        except:
            ...
            print "self.sizeOfOptionalHeader => {}".format(self.sizeOfOptionalHeader)
    ...
    def PE_Structure_sectionText_End(self):  # 5
        ...
        print "self.textFnd => {}".format(self.textEnd)
